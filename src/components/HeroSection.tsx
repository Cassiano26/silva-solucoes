...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-12" id="home">
      <div
      ...
      <div className="relative z-10 max-w-7xl sm:px-6 lg:px-8 mx-auto  text-white">
